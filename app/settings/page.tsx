              ...
              <div className="p-7">
                <form onSubmit={handlePersonalInfoSubmit}>
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      className="flex justify-center rounded-lg border border-red-500 bg-red-50 px-6 py-2 font-medium text-red-500 hover:bg-red-100 dark:border-red-500 dark:bg-red-900/20 dark:text-red-500 dark:hover:bg-red-900/30 cursor-pointer"
                      type="button"
                    >
                      Cancel
                    </button>
                    <button
                      className="flex justify-center rounded-lg bg-primary px-6 py-2 font-medium text-white hover:bg-opacity-90 cursor-pointer"
                      type="submit"
                      disabled={isLoading}
                    >
              ...
              <div className="p-7">
                <form onSubmit={handleImageUploadSubmit}>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      <span className="mb-1.5 block font-bold text-black dark:text-white">
                        Edit your photo
                      </span>
                      <span className="flex gap-2.5">
                        <button
                          type="button"
                          className="text-sm font-medium text-red-500 hover:text-red-600 dark:text-red-400 dark:hover:text-red-500 cursor-pointer"
